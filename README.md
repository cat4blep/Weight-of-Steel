[![Build](https://github.com/cat4blep/Weight-of-Steel/actions/workflows/build.yml/badge.svg?branch=forge-26.1.2)](https://github.com/cat4blep/Weight-of-Steel/actions/workflows/build.yml)
# Weight of Steel
...
1. Install `Forge` for Minecraft `26.1.2`.
...
This branch uses Java `25` for builds.
